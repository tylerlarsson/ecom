...
export const PRICING_PLAN_TYPES = [
  ...
  { id: 2, type: 'subscription', name: 'Subscription', title: 'Subscription Course', description: 'Montly or Annual Billing', isRecurring: true },
  { id: 3, type: 'one-time', name: 'One-Time Purchase', title: 'Paid Course', description: 'A Single Payment', isRecurring: true },
